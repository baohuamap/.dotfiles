...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/baohua/.config/opencode/.gsd-surface.json`
(sibling to `/Users/baohua/.config/opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/baohua/.config/opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/Users/baohua/.config/opencode/skills`).
...
`/Users/baohua/.config/opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/baohua/.config/opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/baohua/.config/opencode/.gsd-surface.json`
Install profile marker: `/Users/baohua/.config/opencode/.gsd-profile`
Skill dirs: `/Users/baohua/.config/opencode/skills/gsd-*/`
Engine module: `/Users/baohua/.config/opencode/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/baohua/.config/opencode/gsd-core/bin/lib/clusters.cjs`
</execution_context>
