...
Reference full template: `/Users/baohua/.config/opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/baohua/.config/opencode/gsd-core/templates/state.md`.
