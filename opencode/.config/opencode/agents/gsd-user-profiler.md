...
<reference>
@/Users/baohua/.config/opencode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/baohua/.config/opencode/gsd-core/references/user-profiling.md` to load:
