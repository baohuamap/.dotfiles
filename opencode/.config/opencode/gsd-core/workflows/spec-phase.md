...
ones). Reference: @/Users/baohua/.config/opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/baohua/.config/opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/baohua/.config/opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/baohua/.config/opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/baohua/.config/opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/baohua/.config/opencode/gsd-core/templates/spec.md.
