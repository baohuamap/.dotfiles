...
<template>
@/Users/baohua/.config/opencode/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/baohua/.config/opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/baohua/.config/opencode/gsd-core/workflows/transition.md`.
...
- Follow @/Users/baohua/.config/opencode/gsd-core/workflows/diagnose-issues.md
