...
Key references:
- @/Users/baohua/.config/opencode/gsd-core/references/ui-brand.md (display patterns)
- @/Users/baohua/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/baohua/.config/opencode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/baohua/.config/opencode/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/baohua/.config/opencode/gsd-core/USER-PROFILE.md" "/Users/baohua/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/baohua/.config/opencode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/baohua/.config/opencode/gsd-core/references/user-profiling.md`
...
Reference: @/Users/baohua/.config/opencode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/baohua/.config/opencode/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/baohua/.config/opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/baohua/.config/opencode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/baohua/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/baohua/.config/opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/baohua/.config/opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/baohua/.config/opencode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/baohua/.config/opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.opencode/AGENTS.md>
  ✓ Global AGENTS.md        /Users/baohua/.config/opencode/AGENTS.md
```
