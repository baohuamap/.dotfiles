...
<required_reading>
@/Users/baohua/.config/opencode/gsd-core/references/user-story-template.md
@/Users/baohua/.config/opencode/gsd-core/references/spidr-splitting.md
@/Users/baohua/.config/opencode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/baohua/.config/opencode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/baohua/.config/opencode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/baohua/.config/opencode/gsd-core/references/spidr-splitting.md`. Briefly:
