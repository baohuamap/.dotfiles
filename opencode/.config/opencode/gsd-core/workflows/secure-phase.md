...
```
Agent(
  prompt="Read /Users/baohua/.config/opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/baohua/.config/opencode/gsd-core/templates/SECURITY.md`
